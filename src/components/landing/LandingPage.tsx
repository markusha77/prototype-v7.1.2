        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-all transform hover:-translate-y-1 duration-300">
            ...
            <p className="text-gray-600">
              Join spaces based on your interests and connect with like-minded builders and
              creators.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-all transform hover:-translate-y-1 duration-300">
            ...
            <p className="text-gray-600">
              Learn from others, collaborate on ideas, and build your network in a supportive
              environment.
            </p>
          </div>
        </div>
      ...
      <footer className="container mx-auto px-4 py-8 border-t border-gray-200 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <p className="text-gray-500">© 2025 Community Spaces. All rights reserved.</p>
          </div>
