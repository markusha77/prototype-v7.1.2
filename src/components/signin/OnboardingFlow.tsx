...
export const OnboardingFlow: React.FC<OnboardingFlowProps> = ({ onComplete, onCancel }) => {
  ...
  const steps = ['Welcome', 'Profile', 'Interests', 'Spaces', 'Complete'];
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 0:
        return <WelcomeStep onNext={handleNext} onCancel={handleCancel} />;
      case 1:
        return (
          <ProfileSetupStep
            userData={userData}
      ...
      case 4:
        return <CompletionStep userData={userData} isLastStep={true} onCancel={onComplete} />;
      default:
        return null;
    }
  };
