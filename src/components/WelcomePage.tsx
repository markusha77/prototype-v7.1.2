  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-indigo-50 to-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-[40%] right-[15%] w-6 h-6 bg-purple-200 rounded-full opacity-20 animate-pulse-slow"
          style={{ animationDelay: '1s' }}
        ></div>
        <div
          className="absolute bottom-[20%] left-[20%] w-10 h-10 bg-blue-200 rounded-full opacity-20 animate-pulse-slow"
      ...
      <div className="cb-wrapper py-16 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Build amazing projects through conversation. Our AI-powered platform helps you create,
            collaborate, and share your ideas with the world.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm p-8 hover:shadow-md transition-all border border-gray-100 transform hover:-translate-y-1 duration-300">
            ...
            <p className="text-gray-600 mb-6">
              Discover projects created by other users, get inspired, and learn from their
              implementations. Filter by categories, technologies, and more.
            </p>
            <Link
              to="/community"
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm p-8 hover:shadow-md transition-all border border-gray-100 transform hover:-translate-y-1 duration-300">
            ...
            <p className="text-gray-600 mb-6">
              Create your own project using our conversational AI builder. Just describe what you
              want to build, and we'll help you bring it to life.
            </p>
            <Link
              to="/builder"
              className="inline-flex items-center text-indigo-600 font-medium hover:text-indigo-800 group"
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl shadow-md p-8 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 mb-6 max-w-2xl mx-auto">
              Join our community of builders and create something amazing today. No coding
              experience required!
            </p>
