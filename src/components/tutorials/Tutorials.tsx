          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            <div>
              ...
              <p className="text-gray-600 mb-6 text-lg">
                A comprehensive guide covering all features and capabilities of ChatAndBuild.
                Perfect for getting started and understanding the full potential of conversational
                development.
              </p>
    ...
    >
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-3">
          <div className="text-indigo-600 p-2 bg-indigo-50 rounded-lg group-hover:bg-indigo-100 transition-colors duration-200">
            {icon}
          </div>
          <span
