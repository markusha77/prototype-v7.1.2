...
const CommunityEditPage: React.FC = () => {
  ...
  return (
    <div style={contentStyle} className="pt-6">
      {/* Main Content */}
      <div className="cb-wrapper pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          {/* Content Area */}
          <div className="lg:col-span-3 bg-white rounded-xl px-4 pt-2 pb-8 shadow-lg">
            <div className="flex items-center justify-between py-4 sticky top-16 bg-white z-20">
