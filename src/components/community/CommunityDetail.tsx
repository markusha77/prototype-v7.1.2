                          ...
                          {[...Array(3)].map((_, index) => (
                            <div key={index} className="aspect-square rounded-lg overflow-hidden">
                              <img
                                ...
                                onError={(e) => {
                                  e.currentTarget.src =
                                    'https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&h=300&q=80';
                                }}
                              />
                            </div>
                          ))}
              ...
              <div className="bg-gradient-to-br from-slate-50 via-white to-gray-50 rounded-xl shadow-lg border border-slate-100 p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <Link
                      to={`/community/${community.id}/discussions`}
                          ...
                          >
                            ...
                            <div className="flex items-center mb-2">
                              ...
                              <span className="text-sm text-gray-600">
                                {index === 0
                                  ? community.admins?.[0]?.name || 'Community Admin'
